...
ActiveRecord::Schema.define(version: 20170525103820) do
  ...
  create_table "songs", force: :cascade do |t|
    ...
    t.integer "year"
    t.bigint "artist_id"
    t.bigint "album_image_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["album_image_id"], name: "index_songs_on_album_image_id"
  ...
  add_foreign_key "songs", "album_images"
